...
export default function VendorOpeningsLayout() {
  ...
  const { openings, pagination, loading, error, loadOpenings } =
    useVendorOpenings();
      ...
      <div className="w-full px-4 py-5">
        <div className="mb-5 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold">Contract Openings</h1>
              <p className="text-sm text-secondary">
                {pagination.total} tenant openings available
              </p>
            </div>
          </div>
              ...
              <tbody className="divide-y divide-border">
                ...
                {!loading &&
                  filteredOpenings.map((opening) => (
                    <tr
                      key={opening.id}
                      className="hover:bg-tableHeader"
                    >
